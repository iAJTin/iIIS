...
namespace iTin.Core.Min.Models.Collections
{
    using System;
    ...
    public abstract class BaseSimpleModelCollection<TItem, TParent> : BaseModel<BaseSimpleModelCollection<TItem, TParent>>, IList<TItem>
    {
        ...
        /// <exception cref="NotSupportedException">The property is set and is readonly.</exception>
        ...
        /// </summary>
        /// <param name="array">The one-dimensional <see cref="Array"/> that is the destination of the elements copied from <see cref="BaseSimpleModelCollection{TItem, TParent}"/>. The <see cref="Array"/> must have zero-based indexing.</param>
        ...
        /// </summary>
        /// <returns>
        /// A <see cref="IEnumerator{TItem}"/> for the <see cref="BaseSimpleModelCollection{TItem, TParent}"/>.
        /// </returns>
