...
namespace iTin.Core.Min.ComponentModel
{
    ...
    public class FrameworkVersion
    {
        ...
        /// <summary>
        /// Initialize a new instance of the <see cref="TargetFrameworkAttribute" /> class.
        /// </summary>
        ...
        {
            string[] items = frameworkAttribute.FrameworkName.Split(new[] {','}, StringSplitOptions.RemoveEmptyEntries);
            VersionName = items[0];

            string[] frameworkVersionItems = items[1].Split(new[] {'='}, StringSplitOptions.RemoveEmptyEntries);
