...
namespace iTin.Core.Helpers
{
    ...
    public static class EnumHelper
    {
        ...
        /// <summary>
        /// Returns a <see cref="Enum" /> whose enum value matches the indicated value.
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        /// Returns a <see cref="IEnumerable{string}"/> that contains enum attribute description of enumerated type.
        /// </summary>
        /// <returns>
        /// A new <see cref="IEnumerable{string}"/> that contains enum attribute description of enumerated type.
        /// </returns>
        ...
        /// <summary>
        /// Returns a <see cref="IEnumerable{string}" /> that contains enum values of enumerated type.
        /// </summary>
        /// <returns>
        /// A new <see cref="IEnumerable{string}" /> that contains enum values of enumerated type.
        /// </returns>
        public static IEnumerable<string> CreateListFromEnumValues<T>() where T : struct => Enum.GetNames(typeof(T)).ToList();

        /// <summary>
        /// Returns a <see cref="IEnumerable{int}" /> that contains enum values of enumerated type as integer values.
        /// </summary>
        /// <returns>
        /// A new <see cref="IEnumerable{int}" /> that contains enum values of enumerated type as integer values.
        /// </returns>
