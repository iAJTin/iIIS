...
namespace iTin.Core.Models
{
    ...
    public class BaseModel<T>
    {
        ...
        public static T LoadFromFile(string fileName, KnownFileFormat format = KnownFileFormat.Xml)
        {
            ...
            try
            {
                var parsedFilenamePath = PathHelper.ResolveRelativePath(fileName);
        ...
        public virtual IResult SaveToFile(string fileName, KnownFileFormat format = KnownFileFormat.Xml, ModelSaveOptions options = null)
        {
            ...
            try
            {
                ...
                var candidateFullPath = PathHelper.ResolveRelativePath(fileName);
                var filenameWithoutExtension = Path.GetFileNameWithoutExtension(candidateFullPath);
                var directoryName = Path.GetDirectoryName(candidateFullPath);
