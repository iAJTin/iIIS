...
namespace iTin.AspNet.Web.IIS.Model
{
    ...
    public partial class FeatureModel : ICloneable
    {
        ...
        #region [public] (IISFeature) Name: Gets or sets the feature's name
        /// <summary>
        ...
        #region [public] (FeaturesModelCollection) Owner: Gets the element that acts as the owner of this feature
        /// <summary>
        ...
        #region [public] (FeatureModel) Clone(): Creates in-depth copy of this instance
        /// <summary>
        ...
        #region [internal] (void) SetOwner(FeaturesModelCollection): Sets the element that acts as the owner of a feature item
        /// <summary>
